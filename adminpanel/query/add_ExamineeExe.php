...
$stmt2 = $conn->prepare("INSERT INTO examinee_tbl (exmne_clu_id, exmne_fname, exmne_mname, exmne_lname, exmne_sfname, exmne_sex, exmne_birthdate, exmne_email, exmne_pass, exmne_status) VALUES (:add_ExmneCluster, :add_ExmneFname, :add_ExmneMname, :add_ExmneLname, :add_ExmneSfname, :add_ExmneSex, :add_ExmneBirth, :add_ExmneEmail, :add_ExmnePass, :add_exmneStatus)");
