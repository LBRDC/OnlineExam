                                                            ...
                                                            foreach ($resulteq1 as $row) {
                                                                ...
                                                                <tr id="<?php echo $exqstn_id; ?>">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <img class="img-fluid w-10 border" src="../uploads/exam_question/<?php echo htmlspecialchars($exam_image); ?>" alt="<?php echo htmlspecialchars($exam_image); ?>" style="max-width: 40%; height: auto;">
                                                                        </a>
                                                                        <?php } ?>
                                                                    </td>
                                                                    <td>
                                                                        ...
                                                                        data-edit-exid="<?php echo htmlspecialchars($ex_id); ?>"
